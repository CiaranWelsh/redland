 ...
 */
typedef char * (*rasqal_generate_bnodeid_handler)(rasqal_world* world, void *user_data, unsigned char *user_bnodeid);
...
RASQAL_API
const char* rasqal_world_guess_query_results_format_name(rasqal_world* world, raptor_uri *uri, const char *mime_type, const char * buffer, size_t len, const unsigned char *identifier);
...
/* Create */
RASQAL_API
rasqal_query* rasqal_new_query(rasqal_world* world, const char *name, const char * uri);
...
RASQAL_API
int rasqal_query_set_feature_string(rasqal_query *query, rasqal_feature feature, const char * value);
RASQAL_API
...
RASQAL_API
int rasqal_query_has_variable2(rasqal_query* query, rasqal_variable_type type, const char * name);
RASQAL_API RASQAL_DEPRECATED
int rasqal_query_has_variable(rasqal_query* query, const char * name);
RASQAL_API
int rasqal_query_set_variable2(rasqal_query* query, rasqal_variable_type type, const char * name, rasqal_literal* value);
RASQAL_API RASQAL_DEPRECATED
int rasqal_query_set_variable(rasqal_query* query, const char * name, rasqal_literal* value);
RASQAL_API
...
/* Query */
RASQAL_API
int rasqal_query_prepare(rasqal_query* query, const char * query_string, raptor_uri *base_uri);
RASQAL_API
...
RASQAL_API
rasqal_query_results_formatter* rasqal_new_query_results_formatter_for_content(rasqal_world* world, raptor_uri *uri, const char *mime_type, const char * buffer, size_t len, const unsigned char *identifier);
RASQAL_API
...
RASQAL_API
unsigned char* rasqal_query_escape_counted_string(rasqal_query* query, const char * string, size_t len, size_t* output_len_p);
...
RASQAL_API
rasqal_literal* rasqal_new_pattern_literal(rasqal_world* world, const char * pattern, const char *flags);
RASQAL_API
rasqal_literal* rasqal_new_string_literal(rasqal_world* world, const char * string, const char *language, raptor_uri *datatype, const unsigned char *datatype_qname);
RASQAL_API
rasqal_literal* rasqal_new_simple_literal(rasqal_world* world, rasqal_literal_type type, const char * string);
RASQAL_API
...
RASQAL_API
rasqal_literal* rasqal_new_decimal_literal(rasqal_world* world, const char * string);
RASQAL_API
rasqal_literal* rasqal_new_decimal_literal_from_decimal(rasqal_world* world, const char * string, rasqal_xsd_decimal* decimal);
RASQAL_API
